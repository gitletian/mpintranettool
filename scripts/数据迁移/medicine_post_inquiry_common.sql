...
----------    rm -rf  ./*/*.zip
----------    beeline -u jdbc:hive2://mphd02:10000 -n fengxiangqing --hivevar date_range='20170705'  -f  /home/data/script/motherbaby_auto.sql
----------
----------
--------------------------------------------------------------------------------------
...
LOAD DATA LOCAL INPATH '/home/data/medicine/post_industry/${hivevar:date_range}/*/*.txt'  INTO TABLE extract.medicine_post_inquiry_txt_add;
